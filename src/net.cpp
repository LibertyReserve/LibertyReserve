...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("LibertyReserve-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("LibertyReserve-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("LibertyReserve-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "LibertyReserve " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("LibertyReserve-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("LibertyReserve-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("LibertyReserve-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("LibertyReserve-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. LibertyReserve is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("LibertyReserve-start");
