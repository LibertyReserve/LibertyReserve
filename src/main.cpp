...
const string strMessageMagic = "LibertyReserve Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LibertyReserve", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Mon, 17 Nov 2014 16:41:31 GMT";
        CTransaction txNew;
        txNew.nTime = 1416242491;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1416242491;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3269992;
		if(fTestNet)
        {
            block.nNonce   = 3269992;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xb1473dcedd0023b44dfdd19f9f2cfb9138ee61e70b0f07db832dcefa41975aad"));
        block.print();
